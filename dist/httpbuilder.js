...
var HttpBuilder = /** @class */ (function () {
    function HttpBuilder(context) {
        this.context = new HttpBuilderContext();
        if (context) {
            Object.assign(this.context, context);
        }
    }
    HttpBuilder.prototype.allow = function (options) {
        ...
        return new HttpBuilder(this.context);
    };
    HttpBuilder.prototype.allowAuthenticated = function () {
        return this.allow({ roles: ['authorized'] });
    };
    HttpBuilder.prototype.onRequest = function (func) {
...
var HttpBuilderContext = /** @class */ (function () {
    function HttpBuilderContext() {
    }
    return HttpBuilderContext;
}());
